...
public class ProgonkaMain {
    ...
    private static void input(InputStreamReader inputStreamReader) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            input(new InputStreamReader(new FileInputStream("matrix.txt")));
        } catch (Exception e) {
